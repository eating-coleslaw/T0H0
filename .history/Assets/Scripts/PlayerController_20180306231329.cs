...
public class PlayerController : MonoBehaviour {
	...
	void Start () {
		...
		doubleJumpGravity = (-2 * maxDoubleJumpHeight / Mathf.Pow(timeToDoubleJumpApex, 2));
	...
	void Update () {
		...
		m_movingForwards = ((Mathf.Sign(velocity.x) == (spriteRenderer.flipX ? -1 : 1) ) || velocity.x == 0);	//facing forwards, really
